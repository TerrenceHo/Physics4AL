...
\addcontentsline{toc}{subsection}{Table 3.1}
\begin{center}
    \begin{tabular}{| c | c | c |}
        \hline
...
9.8 m/s$^2$ was the value of acceleration due to gravity used to calculate 
applied force.  Applied force vs Glider Displacement was used to calculate the
spring coefficient \(k\) in \textbf{Figure 3.1}.}
...
displacement in m.}
\addcontentsline{toc}{subsection}{Figure 3.1}
\end{figure}
...
\addcontentsline{toc}{subsection}{Figure 3.2}
\end{figure}
